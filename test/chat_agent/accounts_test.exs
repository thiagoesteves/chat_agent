defmodule ChatAgent.AccountsTest do
  use ChatAgent.DataCase

  alias ChatAgent.Accounts

  import ChatAgent.AccountsFixtures
  alias ChatAgent.Accounts.{User, UserToken}
  ...
  describe "login_user_by_magic_link/1" do
    ...
    test "raises when unconfirmed user has password set" do
      user = unconfirmed_user_fixture()
      # Scoped to this user: the seeded accounts mean the table is not
      # guaranteed to hold only the fixture.
      {1, nil} =
